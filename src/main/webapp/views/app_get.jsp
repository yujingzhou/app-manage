...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1>添加一个应用</h1>
      <form class="form-horizontal" method="post" action="<%=request.getContextPath() %>/app/put.do" enctype="multipart/form-data">
  <div class="control-group">
    <label class="control-label" for="inputEmail">应用名</label>
    <div class="controls">
      <input type="text" id="inputAppName" placeholder="App Name" name="appname">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputDescription">描述</label>
    <div class="controls">
        <textarea rows="4" id="inputDescription" placeholder="Description" name="description"></textarea>
    </div>
  </div>
  <div class="control-group">
